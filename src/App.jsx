...
const ACCENT = "#D4AF37";
const CTA_DARK = "#3B1024";

const OUTER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(74,10,36,0.96)_0%,rgba(22,29,58,0.94)_52%,rgba(110,67,32,0.90)_100%)]";
const INNER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(32,7,18,0.96)_0%,rgba(16,24,48,0.92)_55%,rgba(70,37,16,0.88)_100%)]";
...
const glass =
  "border border-[rgba(212,175,55,0.22)] bg-[linear-gradient(145deg,rgba(66,11,32,0.68),rgba(20,28,58,0.64),rgba(96,56,28,0.56))] md:backdrop-blur-xl backdrop-blur-sm shadow-[0_12px_34px_rgba(0,0,0,0.28)]";
...
const navItems = [
  ...
  { label: "Nuestros trabajos", href: "#portfolio" },
  { label: "Socios del éxito", href: "#partners" },
  { label: "Contáctanos", href: "#contact" },
];

const stats = [
  { value: "+100", label: "idiomas globales objetivo" },
  { value: "24/7", label: "alcance global continuo" },
  { value: "114", label: "suras completas" },
  { value: "HQ", label: "audio y video de alta calidad" },
];

const heroCards = [
  { value: "114", label: "suras completas" },
  { value: "30", label: "partes del Corán" },
  { value: "experiencia audiovisual", label: "presentación audiovisual" },
];

const heroBadges = [
  { icon: Sparkles, title: "Luz y belleza del Corán" },
  { icon: Globe, title: "Un mensaje para el mundo" },
];
...
const identityCards = [
  {
    icon: Users,
    title: "Quiénes somos",
    text: "Sana es un proyecto benéfico dedicado a difundir los significados del Noble Corán al mundo a través de canales de audio y video que combinan una recitación conmovedora con una traducción precisa, para ofrecer una experiencia espiritual integral que acerque la palabra de Dios a los corazones en distintos idiomas del mundo.",
  },
  {
    icon: Eye,
    title: "Visión",
    text: "Ser una plataforma global líder en llevar los significados del Noble Corán a cada persona en su propio idioma, con un enfoque contemporáneo que combine belleza, excelencia y tecnología moderna.",
  },
  {
    icon: Target,
    title: "Misión",
    text: "Ofrecer contenido coránico traducido en formatos de audio y video que facilite comprender los significados del Noble Corán con claridad y sencillez, y contribuya a difundir la guía y a presentar al mundo la palabra de Dios de una forma impactante y atractiva.",
  },
];
...
const features = [
  {
    ...
    desc: "Transmitir los significados del Noble Corán a los pueblos en sus idiomas con un estilo claro y preciso que respete el sentido y el mensaje.",
  },
  {
    icon: Headphones,
    title: "Experiencia audiovisual integral",
    desc: "Canales que combinan una recitación conmovedora con texto traducido en una experiencia serena acorde con la majestuosidad del Noble Corán.",
  },
  {
    icon: Globe,
    title: "Presencia global continua",
    desc: "Una presencia digital y satelital que abre el acceso a distintos continentes y plataformas las 24 horas.",
  },
  {
    icon: HeartHandshake,
    title: "Un waqf para Dios",
    desc: "Un mensaje de alcance global en cuya recompensa participan quienes contribuyen a difundirlo, apoyarlo o beneficiarse de él.",
  },
];
...
const channels = [
  {
    icon: Radio,
    title: "Canales satelitales y de radio",
    desc: "Difusión de los significados del Noble Corán a través de canales de audio y video que llegan a distintos pueblos en sus idiomas.",
  },
  {
    icon: MonitorPlay,
    title: "Redes sociales y sitios web",
    desc: "Una presencia digital renovada que facilita el acceso al contenido coránico y su difusión a gran escala.",
  },
  {
    icon: Layers3,
    title: "Aplicaciones y medios digitales diversos",
    desc: "Una experiencia moderna y diversa que permite seguir el contenido coránico de formas adecuadas para distintos dispositivos y plataformas.",
  },
];
...
const partners = [
  {
    icon: ShieldCheck,
    title: "Entidades islámicas y académicas",
    desc: "Que contribuyeron a ofrecer traducciones acreditadas de los significados del Noble Corán, garantizando precisión y solidez académica.",
  },
  {
    icon: Mic2,
    title: "Recitadores influyentes de voz hermosa",
    desc: "Que enriquecieron el proyecto con recitaciones reverentes y emotivas, capaces de llegar al corazón de forma atractiva y cercana.",
  },
  {
    icon: Headphones,
    title: "Empresas de producción audiovisual y técnica",
    desc: "Que aportaron grabaciones de alta calidad y un tratamiento profesional de audio y video.",
  },
  {
    icon: Users,
    title: "Productores y voluntarios",
    desc: "Que contribuyeron al desarrollo y la difusión del contenido para llegar al mayor público posible en todo el mundo.",
  },
];
...
const impactCards = [
  {
    ...
    desc: "El mensaje del Noble Corán llegó a hogares de distintos países del mundo, en varios idiomas que hablan a las personas en su lengua materna.",
  },
  {
    icon: Languages,
    title: "Traducciones confiables",
    desc: "Se han proporcionado traducciones precisas de los significados del Noble Corán bajo la supervisión de entidades académicas confiables para garantizar la exactitud del sentido.",
  },
  {
    icon: Headphones,
    title: "Experiencia integral",
    desc: "Contenido que combina una recitación reverente con traducción visual para ofrecer una experiencia espiritual impactante y fácil de comprender.",
  },
  {
    icon: Send,
    title: "Mensaje en expansión",
    desc: "El proyecto contribuye a difundir la guía y a dar a conocer al mundo la palabra de Dios con un enfoque moderno que llega a distintos públicos.",
  },
];
...
function HeroAudioPlayer({ isMobile }) {
  ...
  return (
    <div className="mt-5 rounded-[1.35rem] border border-white/10 bg-[rgba(24,10,24,0.55)] p-3 sm:p-4">
      <audio
        ref={audioRef}
        preload="metadata"
      ...
      <div className="mb-4 flex h-14 items-end gap-[2px] overflow-hidden rounded-2xl border border-white/10 bg-black/10 px-2 py-3 sm:h-18">
        {bars.map((height, index) => (
          <motion.div
            ...
            className="flex-1 self-end rounded-full bg-gradient-to-t from-[#6A0F35] via-[#D4AF37] to-[#1C2E5A] opacity-95"
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative h-2 w-full flex-1 overflow-visible rounded-full bg-white/10">
          <div
            className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-[#6A0F35] via-[#D4AF37] to-[#1C2E5A]"
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-gradient-to-r from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-[rgba(212,175,55,0.12)]">
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-[rgba(24,10,24,0.55)] px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8">
          {desc}
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        ...
        <div
          className={`mt-4 rounded-2xl border border-white/10 bg-[rgba(24,10,24,0.55)] px-4 py-4 text-white/80 ${
            large
...
function ImpactCard({ icon: Icon, title, desc, isMobile }) {
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-gradient-to-r from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-[rgba(36,55,110,0.18)]">
            <Icon className="h-5 w-5" style={{ color: ACCENT }} />
          </div>
    ...
    >
      <div className="relative overflow-hidden rounded-[1.4rem] border border-white/10 bg-black/30">
        ...
        <div className="pointer-events-none absolute left-3 top-3 rounded-full border border-white/10 bg-black/35 px-3 py-1 text-[11px] text-white/80 backdrop-blur-md">
          {isReady ? "Vista previa visible antes de reproducir" : "Preparando vista previa"}
        </div>
      </div>

      <div className="mt-4 rounded-[1.3rem] border border-white/10 bg-[rgba(24,10,24,0.55)] p-3 sm:p-4">
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={toggleMute}
...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(212,175,55,0.18),transparent_30%),radial-gradient(circle_at_80%_20%,rgba(128,30,74,0.18),transparent_24%),radial-gradient(circle_at_20%_80%,rgba(36,55,110,0.18),transparent_26%),linear-gradient(180deg,#120611_0%,#1b0b1b_30%,#111d3a_68%,#2a170d_100%)]" />

        {!isMobile && (
          <>
            <motion.div
              className="absolute -top-24 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-[rgba(212,175,55,0.16)] blur-3xl"
              animate={pulseGlow}
            />
        ...
        <div className={containerClass}>
            ...
            >
              <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-yellow-100/20 bg-white/10 shadow-[0_0_16px_rgba(16,185,129,0.16)] sm:h-16 sm:w-16">
                  <img
                    src={sanaLogo}
                    alt="Logo de Sana Quranic Channels"
              ...
              <nav className="hidden items-center gap-3 md:flex">
                {navItems.map((item) => (
                  <a
                    key={item.href}
                    href={item.href}
                    className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/85 transition hover:border-emerald-200/30 hover:bg-white/10 hover:text-[#F8E7B0]"
                  >
                    {item.label}
                  </a>
                ))}
          ...
          <section className="relative grid min-h-[auto] items-center gap-10 py-10 sm:gap-12 sm:py-14 lg:min-h-[84vh] lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
            <div className="order-1 lg:order-1">
              ...
              >
                ...
                <span>Sana... un mensaje para toda la humanidad</span>
              </motion.div>
              ...
              >
                Canales de audio y video para traducir los significados del Noble Corán a todos los idiomas del mundo — un waqf para Dios.
              </motion.p>
              ...
              >
                ...
                <a
                  href="https://www.youtube.com/@SANA-Esp-k9l"
                  target="_blank"
                  rel="noreferrer"
            ...
            >
              ...
              >
                <div className="rounded-[1.6rem] border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-4 sm:p-6">
                  ...
                  <div className="mt-6 rounded-[1.4rem] border border-white/10 bg-[rgba(18,20,42,0.68)] p-4 sm:mt-8 sm:p-6">
                    <div className="mb-4 flex items-start gap-3 text-sm text-white/80 sm:items-center sm:text-base">
                      <Headphones className="mt-0.5 h-5 w-5 shrink-0 text-[#E8C96A] sm:mt-0" />
                      <span>Escucha la recitación con una presentación visual de los significados del Noble Corán</span>
                    </div>
                      ...
                      <div className="space-y-3">
                        {[65, 88, 42].map((w, idx) => (
                          <motion.div
                            ...
                            className="h-3 rounded-full bg-gradient-to-r from-[#6A0F35] via-[#D4AF37] to-[#1C2E5A]"
                          />
                        ))}
                      </div>
                    )}
          ...
          <section id="about" className="py-4 lg:py-8">
            ...
            >
              <LargeSectionBadge icon={BookOpen} text="Identidad coránica global" />
            </motion.div>
          ...
          <section className="py-8 lg:py-12">
            <div className="mb-6 text-center">
              <LargeSectionBadge icon={Building2} text="Implementación y supervisión" />
            </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch lg:gap-8">
                  <div className="rounded-[1.8rem] border border-white/10 bg-[rgba(22,12,24,0.50)] p-4 sm:p-6">
                    <div className="h-full rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
                      <h2 className="text-2xl font-black sm:text-3xl lg:text-4xl">
                        Alianza operativa confiable
                      </h2>
                      <p className="mt-5 text-base leading-8 text-white/75 sm:text-lg">
                        
                        <span className="font-bold text-white">Canales Coránicos Sana</span>{" "}
                        es ejecutado por{" "}
                        <span className="font-bold" style={{ color: ACCENT }}>
                          la Saudi Jordanian Company for Satellite Broadcasting (JASCO)
                        </span>{" "}
                        — en Amán, Jordania, con una amplia experiencia líder en producción y radiodifusión.
                      </p>
                    </div>
                  </div>

                  <div className="rounded-[1.8rem] border border-white/10 bg-[rgba(20,12,28,0.70)] p-4 sm:p-6">
                    <div className="flex h-full flex-col justify-center rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
                      <div className="text-sm text-white/60">Sitio oficial</div>
                      <div className="mt-2 text-xl font-bold sm:text-2xl">Jasco Media City</div>
                      <a
                        href="https://jascomediacity.net/"
                        target="_blank"
                        rel="noreferrer"
                        className="mt-5 inline-flex w-fit items-center gap-2 rounded-2xl border border-[rgba(212,175,55,0.22)] bg-[rgba(106,15,53,0.22)] px-5 py-3 text-sm text-[#F8E7B0] transition hover:bg-[rgba(106,15,53,0.34)] sm:text-base"
                      >
                        Visita el sitio de JASCO
          ...
          <section id="features" className="py-12 lg:py-20">
            ...
            >
              {sectionBadge(Sparkles, "Características de la plataforma")}
              ...
              <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                Una plataforma coránica que utiliza medios modernos para transmitir los significados del Noble Corán al mundo, con un enfoque que combina el rigor académico islámico y la tecnología contemporánea.
              </p>
            </motion.div>
          ...
          <section className="py-10 lg:py-14">
            <motion.div
              ...
              className="mb-10 text-center"
            >
              {sectionBadge(Send, "Canales de difusión y alcance")}
              <h2 className="mt-5 text-2xl font-black sm:text-4xl lg:text-5xl">Múltiples canales de presencia</h2>
            </motion.div>
          ...
          <section id="portfolio" className="py-12 lg:py-20">
            <motion.div
              ...
              className="mb-10 text-center"
            >
              {sectionBadge(Crown, "Nuestros trabajos")}
              <h2 className="mt-5 text-2xl font-black sm:text-4xl lg:text-5xl">Muestras de nuestro trabajo</h2>
              <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                Recitaciones coránicas inspiradoras y traducciones de los significados de los versículos del Noble Corán a distintos idiomas del mundo — Sana... un mensaje para toda la humanidad.
              </p>
            </motion.div>
          ...
          <section className="py-12 lg:py-16">
            <motion.div
              ...
              className="mb-10 text-center"
            >
              {sectionBadge(Globe, "Impacto del proyecto")}
              <h2 className="mt-5 text-2xl font-black sm:text-4xl lg:text-5xl">
                Impacto del proyecto y su expansión por el mundo
              </h2>
              <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                Un mensaje coránico global que ha proporcionado traducciones confiables, ofrecido una experiencia impactante y contribuido a llevar los significados del Noble Corán a hogares de todo el mundo.
              </p>
            </motion.div>
          ...
          <section id="partners" className="py-12 lg:py-20">
            <motion.div
              ...
              className="mb-10 text-center"
            >
              {sectionBadge(Users, "Socios del éxito")}
              <h2 className="mt-5 text-2xl font-black sm:text-4xl lg:text-5xl">Un éxito construido con colaboración</h2>
              <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-white/70 sm:text-lg">
                El proyecto alcanzó su éxito gracias a la colaboración de un grupo distinguido de entidades, entre ellas instituciones académicas y religiosas, medios, equipos de producción y voluntarios.
              </p>
            </motion.div>
            ...
            >
              <div className="text-center">
                ...
                <p className="mx-auto mt-5 max-w-4xl text-base leading-8 text-white/75 sm:text-lg">
                  Sana es un mensaje global de divulgación, y estaremos encantados de comunicarnos contigo y recibir tus consultas, sugerencias y propuestas de colaboración en cualquier momento de forma clara y directa.
                </p>
              </div>
              ...
              >
                <div className="rounded-[2rem] border border-white/10 bg-[rgba(20,12,28,0.70)] p-4 sm:p-6">
                  <div className="rounded-[1.5rem] border border-white/10 bg-white/5 p-4 sm:p-5">
                    <div className="mb-4 text-xl font-bold sm:text-2xl">Contáctanos</div>
                    <div className="space-y-3 text-white/75">
                      <div className="rounded-2xl bg-white/5 px-4 py-3 text-sm sm:text-base">
                        Nuestro equipo estará encantado de ayudarte y responderte lo antes posible.
                      </div>
                      <a
                        href="mailto:snachannel159@gmail.com"
                        className="flex items-center justify-center gap-3 rounded-2xl border border-[rgba(212,175,55,0.22)] bg-[rgba(106,15,53,0.22)] px-4 py-3 text-center text-sm font-semibold text-[#F8E7B0] transition hover:bg-[rgba(106,15,53,0.34)] sm:text-base"
                      >
            ...
            <div className={`rounded-[2rem] px-4 py-6 sm:px-6 sm:py-8 lg:px-10 ${glass}`}>
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                ...
                <div className="rounded-[1.6rem] border border-white/10 bg-white/5 p-4 sm:p-5 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="mt-6 w-full rounded-[1.4rem] border border-white/10 bg-[rgba(22,12,24,0.50)] p-4">
                    <a
                      href="https://www.facebook.com/profile.php?id=61571197880780"
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <p className="mt-4 text-center text-sm leading-6 text-white/70">
                      Comienza tu viaje coránico ahora
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-[1.8rem] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.08),rgba(255,255,255,0.04))] p-4 backdrop-blur-md sm:p-5 flex flex-col items-center justify-center text-center">
                  <div className="mb-5 flex flex-col items-center justify-center gap-4 text-lg font-bold text-white sm:text-xl">
                    ...
                    <span>Enlaces de nuestra app</span>
                  </div>

                  <div className="w-full rounded-[1.4rem] border border-white/10 bg-[rgba(22,12,24,0.50)] p-4">
                    <p className="mb-4 text-sm leading-7 text-white/65">
                      Descarga la aplicación y comienza a seguir el contenido coránico fácilmente a través de las plataformas oficiales.
                    </p>
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      ...
                      >
                        <div className="flex items-center justify-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-[rgba(212,175,55,0.12)] text-white">
                            <GooglePlayIcon />
                          </div>
                      ...
                      >
                        <div className="flex items-center justify-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-[rgba(36,55,110,0.18)] text-white">
                            <AppStoreIcon />
                          </div>
                    ...
                    <div className="mt-5 rounded-[1.4rem] border border-white/10 bg-[rgba(18,20,42,0.60)] p-4">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-[rgba(212,175,55,0.22)] bg-[rgba(106,15,53,0.22)] py-3 text-sm font-bold text-[#F8E7B0] transition hover:scale-[1.01] hover:bg-[rgba(106,15,53,0.34)]"
                      >
              ...
              <div className="mt-8 border-t border-white/10 pt-5 text-center text-xs text-white/55 sm:text-sm">
                Todos los derechos reservados © Canales Coránicos Sana.
              </div>
            </div>
          </footer>
        </div>
